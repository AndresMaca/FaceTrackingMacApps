package com.macapps.developer.facetrackingmacapps;
...
/**
 * Created by Developer on 28/6/2017.
 */

public class CameraOverlay extends View {
    private final Object mLock = new Object();
    private int mPreviewWidth;
    private float mWidthScaleFactor = 1f;
    private int mPreviewHeight;
    private float mHeightScaleFactor = 1f;
